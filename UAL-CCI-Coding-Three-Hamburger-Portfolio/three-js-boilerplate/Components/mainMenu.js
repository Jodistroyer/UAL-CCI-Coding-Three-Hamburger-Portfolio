...
const textData = [
    ...
    { 
        ...
        images: [
            { src: "./assets/principle/principle.png", alt: "Fresh lettuce" },
        ],
        buttons: [
    ...
    { 
        ...
        images: [
            { src: "./assets/dynamic/lumbermart.jpg", alt: "Fresh lettuce" },
            { src: "./assets/dynamic/backley.jpg", alt: "Fresh lettuce" },
        ],
        buttons: [
